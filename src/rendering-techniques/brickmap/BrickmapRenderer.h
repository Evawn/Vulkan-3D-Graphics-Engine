...
class BrickmapRenderer : public RenderTechnique {
private:
	...
	// Graph-managed brickmap structure buffer (top grid + brick bitmasks)
	BufferHandle m_brickmap_buffer;
	VkBuffer m_brickmap_vk_buffer = VK_NULL_HANDLE; // cached for vkCmdFillBuffer
...
public:
	std::string GetName() const override { return "Brickmap Renderer"; }
